...
class Navbar extends Component{
	constructor(props) {
		super(props)
		this.view = store.retrieveLanguageView("japanese")
	}
		...
		return (
			<nav>
				<div className="nav-wrapper white accent-text">
					...
					<a className="brand-sublogo accent-text hide-on-med-and-down"><span className="brand-name">Buddies</span>     {this.view.sublogo}</a>
					...
					<ul id="lang-dropdown1" className="dropdown-content">
						<li><a onClick={this.props.changeLanguage("japanese")} className="accent-text center">日本語</a></li>
						<li><a onClick={this.props.changeLanguage("english")} className="accent-text center">English</a></li>
						<li><a onClick={this.props.changeLanguage("chinese")} className="accent-text center">中文</a></li>
					</ul>
